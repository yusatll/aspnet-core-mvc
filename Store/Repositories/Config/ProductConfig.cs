...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        ...
        {
            builder.HasKey(p => p.ProductId); // Primary Key belirtmek için
            builder.Property(p => p.ProductName).IsRequired(); // Not Null belirtmek için
            builder.Property(p => p.Price).IsRequired(); // Not Null belirtmek için
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 5, CategoryId = 2, ImageUrl="/images/5.jpg", ProductName = "Deck", Price = 1_600 },
